...
enum ProductID {
    static let monthly = "com.zzoutuo.FairShift.pro.monthly"
    static let yearly = "com.zzoutuo.FairShift.pro.yearly"
    static let lifetime = "com.zzoutuo.FairShift.pro.lifetime"
